...
// Run a demonstration
function runELLMDemo() {
  const ellm = new ELLM();
  
  console.log("=======================================");
  console.log("ELLM - Efficient Language and Logic Model");
  console.log("=======================================\n");
  
  console.log("Teaching ELLM some basic knowledge...\n");
  
  // Basic knowledge
  const learningResults = ellm.learn(`
  ...
  learningResults.forEach(result => console.log(result));
  
  console.log("\nKnowledge base loaded. Here's what ELLM knows:\n");
  ellm.explainKnowledgeBase();
  
  console.log("\n=======================================");
  console.log("Testing ELLM's reasoning capabilities");
  console.log("=======================================\n");
  ...
  const queries = [
    ...
    "Can birds fly?",
    "Can penguins fly?",
    "Is the engine part of the transportation system?",
    "Does Alice like Bob?"
  ];
  
  queries.forEach(q => {
    const result = ellm.query(q);
    console.log(`Query: ${result.query}`);
    console.log(`Parsed as: ${result.parsedQuery || "Failed to parse"}`);
    console.log(`Answer: ${result.answer}`);
    console.log(`Explanation: ${result.explanation}\n`);
  });
  
  console.log("=======================================");
  console.log("ELLM Demo Complete");
  console.log("=======================================");
